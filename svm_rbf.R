...
model <- train(status~., data=standardised_pc_transcriptomic_df_133, method="svmRadial", trControl=cross_validation)
...
model <- train(status~., data=reduced_transcriptomic_df, method="svmRadial", trControl=cross_validation)
