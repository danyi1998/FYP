...
model <- train(status~., data=standardised_pc_transcriptomic_df_133, method="svmLinear", trControl=cross_validation)
...
model <- train(status~., data=reduced_transcriptomic_df, method="svmLinear", trControl=cross_validation)
